        ...
        if(StringUtils.isNotEmpty(existingValues)) {
            ...
            for(String key: keys) {
                if(configFile.hasFieldComponent(key)) {
                    ...
                    int v;
                    if(configurationComponent.hasType("forms:UriField")) {
                    ...
                    } else if(configurationComponent.hasType("forms:LiteralField")) {
                        for(v = 0; v < valuesLength; v++) {
    ...
    void updateConfiguration(Map<String, String[]> parameterMap) 
        ...
        for(String s: satisfiedVarNames) {
            ...
            if(!isReservedVarName(s)) {
                ...
                if(component.hasType("forms:UriField") || component.hasType("forms:ConstantOptionsField")) {
                    //create URI field component
                    this.editConfiguration.addUrisOnForm(s);
                    addField = true;
                    isURI = true;
                } else if(component.hasType("forms:LiteralField")){
