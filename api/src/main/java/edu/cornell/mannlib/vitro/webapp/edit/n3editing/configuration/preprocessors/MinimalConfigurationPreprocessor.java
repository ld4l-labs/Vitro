...
public class MinimalConfigurationPreprocessor extends
	...
	void updateConfiguration(Map<String, String[]> parameterMap) 
		...
		// Attach allowedN3 as n3 optional 
        // (AllowedN3 is generated in part by optional N3 - retractions are based on required/optional 
		// and a situation can occur when optional N3 was not defined initially but if we add everything to required, 
        // the retractions will require values where there weren't any to begin with due to those being optional 
        // the first time the info was added.
